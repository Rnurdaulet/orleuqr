    ...
    for participant in participants:
        ...
        for session in sessions:
            ...
            data.append({
                ...
                "arrived_status": att.get_arrived_status_display() if att else None,
                "left_status": att.get_left_status_display() if att else None,
                "marked_entry": att.marked_entry_by_trainer.full_name if att and att.marked_entry_by_trainer else None,
                "marked_exit": att.marked_exit_by_trainer.full_name if att and att.marked_exit_by_trainer else None,
